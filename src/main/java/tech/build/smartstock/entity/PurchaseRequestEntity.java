package tech.build.smartstock.entity;
...
public class PurchaseRequestEntity {
    ...
    @Field(name = "last_stock_date_time")
    private LocalDateTime lastStockDateTime;
    ...
    public LocalDateTime getLastStockDateTime() {
        return lastStockDateTime;
    }

    public void setLastStockDateTime(LocalDateTime lastStockDateTime) {
        this.lastStockDateTime = lastStockDateTime;
    }
